...
def KitModel(weight_file = None):
    ...
    with tf.Session() as sess:  # initialze a sess
        ...
        saver.save(sess, 'model_add_softmax')
        tf.io.write_graph(sess.graph_def, "/tmp/my_model", "model_add_softmax.pbtxt", as_text=True)
    return data, fc1
